...
This component uses the Daren/DR-BMS RS485 protocol documented in the daren-485 repo linked below; a stand-alone implementation in Python is in [`scripts/bms_query.py`](scripts/bms_query.py).
