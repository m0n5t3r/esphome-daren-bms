...
public:
  ...
  // binary sensors
  void set_balancing_binary_sensor(
      binary_sensor::BinarySensor *balancing_binary_sensor) {
    this->balancing_binary_sensor_ = balancing_binary_sensor;
  }
  void set_charging_binary_sensor(
      binary_sensor::BinarySensor *charging_binary_sensor) {
    this->charging_binary_sensor_ = charging_binary_sensor;
  }
  void set_discharging_binary_sensor(
      binary_sensor::BinarySensor *discharging_binary_sensor) {
    this->discharging_binary_sensor_ = discharging_binary_sensor;
  }
  void set_online_status_binary_sensor(
      binary_sensor::BinarySensor *online_status_binary_sensor) {
    this->online_status_binary_sensor_ = online_status_binary_sensor;
  }

  // sensors
  void
  set_delta_cell_voltage_sensor(sensor::Sensor *delta_cell_voltage_sensor) {
    this->delta_cell_voltage_sensor_ = delta_cell_voltage_sensor;
  }
  void
  set_average_cell_voltage_sensor(sensor::Sensor *average_cell_voltage_sensor) {
  ...
  void
  set_temperature_sensor_1_sensor(sensor::Sensor *temperature_sensor_1_sensor) {
    this->temperature_sensor_1_sensor_ = temperature_sensor_1_sensor;
  }
  void
  set_temperature_sensor_2_sensor(sensor::Sensor *temperature_sensor_2_sensor) {
    this->temperature_sensor_2_sensor_ = temperature_sensor_2_sensor;
  }
  void
  set_temperature_sensor_3_sensor(sensor::Sensor *temperature_sensor_3_sensor) {
    this->temperature_sensor_3_sensor_ = temperature_sensor_3_sensor;
  }
  void
  set_temperature_sensor_4_sensor(sensor::Sensor *temperature_sensor_4_sensor) {
  ...
  void
  set_capacity_remaining_sensor(sensor::Sensor *capacity_remaining_sensor) {
    this->capacity_remaining_sensor_ = capacity_remaining_sensor;
  }
  void
  set_temperature_sensors_sensor(sensor::Sensor *temperature_sensors_sensor) {
  ...
  // cell sensors
  void set_cell_voltage_sensor(uint8_t cell,
                               sensor::Sensor *cell_voltage_sensor) {
    if (cell < 16) {
...
protected:
  ...
  void update_sensor_(binary_sensor::BinarySensor *binary_sensor,
                      const bool &state);
